// ConsoleApplication2.cpp: определяет экспортированные функции для приложения DLL.
//
#include "stdafx.h"
...
RCA_crypt long long* __stdcall ToLong(char* a, int &l){//представление каждого cимвола в массиве числом 
...
RCA_crypt char* __stdcall ToChar(long long* a, int l){//представление числа символом
